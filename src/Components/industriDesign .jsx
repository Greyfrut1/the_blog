...
function IndustriDesign() {
  ...
  return (
    <div className="font-poppins">
      <h3 className="text-base font-semibold text-white/30 uppercase mb-[40px] px-[12px] md:px-[28px]">
        Industri Design
      </h3>
      <div className="">
        <Slider {...settings}>
          {teasers.map((item, index) => (
            <div
              className="w-6/12 h-auto lg:h-[510px] lg:w-3/12 border-r border-white/30"
              key={index}
            >
              <a className="block px-[12px] md:px-[28px]">
                ...
                ></img>
                <div
                  className="text-[11px] pt-[16px] pb-[10px] font-normal text-white/30"
                  dangerouslySetInnerHTML={{ __html: item.field_date }}
                ></div>
                <div className="text-[18px] leading-[24px] md:text-[22px] font font-semibold md:leading-[35px] text-white">
                ...
                <div>
                  <div
                    className="text-white/70 text-ellipsis pt-[20px] font-extralight hidden lg:line-clamp-6 lg:text[15px] xl:text-[18px]"
                    key={index}
                  >
                    {striptags(item.body)}
                  </div>
